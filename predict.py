...
model = sm.Unet(BACKBONE,
                ...
                weights = 'best_model_mobilnetv2.h5',#load the pretrained weights
...
def test_performance():
    ...
    return np.median(times),(1./np.median(times))

time,FPS = test_performance()
print('average FPS:',FPS,'consumed time:',time)
